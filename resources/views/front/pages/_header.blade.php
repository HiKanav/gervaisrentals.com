            ...
            <div class="col-md-12">
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div style="display: flex; justify-content: space-evenly; flex-wrap: wrap;">
                        ...
                        <div class="navbar-header">
                            <a href="{{action('Front\PageController@getIndex')}}" style="margin-left: 27px; width:100%; margin: 0 auto;" class="navbar-brand">
                                <img src="{{asset('default/front/imgs/75-year-gervaise.jpg')}}" alt="Logo">
                            </a>
                        </div>
                    </div>
                    {{-- --- --}}
                        ...
                        <ul class="nav navbar-nav navbar-right">
                                    ...
                                    @foreach($categories->sortBy('name')->chunk(10) as $category1)
                                        <div class="col-md-4" style="padding: 10px 38px">
                                            @foreach($category1 as $category) 
                                                <li><a style="display: block !important; line-height: 22px;" href="{{route('category-products', [$category->route_name])}}">{{$category->name}}</a></li></br>
                                            @endforeach
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <li class="dropdown"> 
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{action('Front\PageController@getVaccinationTentRentals')}}">Vaccination Tent Rentals</a></li>
                                    <br>
                            ...
                            <li class="dropdown"> 
                                ...
                                <ul class="dropdown-menu">
                                    <!-- <div class="row">
                                        <div class="col-md-4" style="padding: 10px 38px"> -->
                                            <li><a href="{{action('Front\PageController@getweddingBackyardMicroRentals')}}">Backyard / Micro Weddings</a></li><br>
                                            <li><a href="{{action('Front\PageController@getBbqRentals')}}">BBQ Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getBridalShowRentals')}}">Bridal Show Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getCorporateEventRentals')}}">Corporate Event Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getCanadaDayRentals')}}">Canada Day Rentals</a></li><br>
                                        <!-- </div>
                                        <div class="col-md-4" style="padding: 10px 38px"> -->
                                            <li><a href="{{action('Front\PageController@getChristmasMarketRentals')}}">Christmas Market Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getChristmasPartyRentals')}}">Christmas Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getConvocationGraduationRentals')}}">Convocation Graduation Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getEasterRentals')}}">Easter Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getFallFestivalRentals')}}">Fall Festival Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@gethousePartyRentals')}}">House Party Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getMothersDayRentals')}}">Mother's Day Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getMusicFestivalRentals')}}">Music Festival Rentals</a></li><br>
                                        <!-- </div>
                                        <div class="col-md-4" style="padding: 10px 38px"> -->
                                            <li><a href="{{action('Front\PageController@getNewYearPartyRentals')}}">New Years Party Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getPartyRentals')}}">Party Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getPassoverRentals')}}">Passover Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getEventRentalsPickering')}}">Pickering Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getStPatricksDayRentals')}}">St. Patrick's Day Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getThanksgivingRentals')}}">ThanksGiving Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getTradeshowBoothRentals')}}">Tradeshow Booth Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getValentinesDayRentals')}}">Valentine's Day Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getWeddingChairRentals')}}">Wedding Chair Rentals</a></li><br>
                                            <li><a href="{{action('Front\PageController@getweddingRentals')}}">Wedding Rentals</a></li><br>
                                      <!--   </div>
                                    </div> -->
                                </ul>
                            </li>
                            ...
                            <li class="dropdown"> 
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{action('Front\PageController@getEventRentalsAurora')}}">Aurora</a></li><br>
                                    ...
                                    <li><a href="{{action('Front\PageController@getEventRentalsVaughan')}}">Vaughan</a></li><br>
                                    <li><a href="{{action('Front\PageController@getEventRentalsWhitby')}}">Whitby Rentals</a></li><br>
                                </ul>
                            </li>
                        </ul>
                    </div>
