				...
				{!!Form::open(['action' => 'Front\PageController@postRequestQuote'])!!}
					@foreach($productDetails as $product)
			            <tr>
			                ...
			                <td><input type="number" min="0" step="{{$product->qtyMultiple()}}" class="form-control" value="{{$productQuantity[$product->id]}}" name="product_quantity[{{$product->id}}]"></td>
	...
	@if($price)
		<div class="row">
		    <div class="col-sm-10 col-sm-offset-1">
				<div class="well">When you have finalized your quote, please complete the form below and we will send you a copy by email. </div>
		    </div>
		</div>
